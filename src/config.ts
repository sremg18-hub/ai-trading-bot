...
export function loadConfig(): Config {
  return {
    ...
    takeProfitPercent: Number(process.env.TAKE_PROFIT_PERCENT) || 0.5,
    ...
    cryptoCheckIntervalMs: Number(process.env.CRYPTO_CHECK_INTERVAL_MS) || 120000, // 2min crypto cycles
